...
<nav class="navla">
  ...
  <div class="container">
    <div class="row">
          <div class="col me-2">
            <Link to="/home" className='homelink  me-5'><i class="bi bi-house-door-fill"></i></Link>
            <Link to="category" className='homelink me-5 Bold text'>Category</Link>
            <Link to="/book" className='homelink me-5 Bold text'>Books</Link>
            <Link to="manga" className='homelink me-5 Bold text'>Manga</Link>
            </div>
      ...
      <Link onClick={onLogoutHandler} className='btn btn-warning'>Logout</Link>
      </>
      ) : (
        <>
